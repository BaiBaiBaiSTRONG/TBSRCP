...
class PoinTr(nn.Module):
    def __init__(self, config, **kwargs):
        ...
        self.num_pred = config.num_pred   # 499
        self.num_query = config.num_query # 30
        ...
        # self.cls_input = nn.Linear(1024, 192)
        # self.cls_hidden = nn.Linear(192, 96)
        # self.cls_output = nn.Linear(96, 28)
    ...
    def forward(self, xyz):
        ...
        if DisplayDebug:
            ...
            print('XYZ:')
            print(xyz.shape)
            print('Rebuild Points shape Before Merge:')

        

        ret = (coarse_point_cloud, inp_sparse, cls)
        return ret
